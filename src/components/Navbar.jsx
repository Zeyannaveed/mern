          ...
          <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center">
            ...
            <div className="ml-28 flex">
              ...
              onChange={(e)=>{setinputdata(e.target.value)}}
                type="text"
                size="40"
                className="input h-10  rounded-tl-lg rounded-bl-lg p-2 text-base border text-white "
                placeholder="Search..."
              />
              <span className="orange cursor-pointer rounded-tr-lg rounded-br-lg">
              <Link state={{ search: inputdata }} to="/catagory">
                <img src={searchicon} onClick={searchfunc} className="w-10" alt="" />
              </Link>
              </span>
            </div>
            ...
            <div className="ml-auto">
              <img
                src={cartimg}
                className="w-10  float-left p-2 orange  rounded-lg"
                alt=""
              />
              <img
                ...
                src={accountimg}
                className="w-9  ml-2 float-right "
                alt=""
              />
            </div>
          </div>
